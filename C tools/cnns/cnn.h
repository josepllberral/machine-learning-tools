...
// Compile using "gcc flat.c line.c matrix_ops.c msel.c relu.c sigm.c test.c cnn.c conv.c grad_check.c mlp.c pool.c relv.c soft.c dire.c tanh.c rbml.c xent.c -lgsl -lgslcblas -lm -o cnn"
